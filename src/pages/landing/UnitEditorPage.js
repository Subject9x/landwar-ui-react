...
function UnitEditorPage(){
    ...
    <div class="grd">
        <div class="grd-row">
            <div class="grd-row-col-4--sm grd-row-col-4--md grd-row-col-5-lg txt--center">
                <h3>Unit Editor - Core</h3>
            </div>
        </div>
        
        <div class="grd-row">
            <div class="grd-row-col-4--sm grd-row-col-3--md grd-row-col-2--lg">
                <p>
        ...
        <div class="grd-row">
            <div class="grd-row-col-4-6--sm grd-row-col-3-6--md grd-row-col-2-6--lg">
                <button type="button" title="Create blank Unit Editor Sheet" onclick="ub_control_sheet_new();" class="btn--green ui-icon-white"><span class="ui-icon ui-icon-document"></span></button>
                <button type="button" title="Open a valid Unit Editor or Army List CSV." onclick="ub_control_sheet_import();" class="btn--blue ui-icon-white"><span class="ui-icon ui-icon-folder-open"></span></button>
            </div>
        </div>
    </div>
    )
